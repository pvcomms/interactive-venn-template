...
| **Local** | `~/work/capp/instruments/venn` |
| **GitHub** | [pvcomms/interactive-venn-template](https://github.com/pvcomms/interactive-venn-template) |
| **Live** | https://interactive-venn-template.vercel.app |
| **Surface** | public — interactive-venn-template.vercel.app |

A hover-flood, cursor-reactive Venn diagram you configure in the browser. One file, no build.
...
Siblings (instrument, capp): `chronology`, `nervous-system-sandbox`, `suji`, `terra-cognita`, `think-forward-reverse`.
